...
# Get trending posts
trending = client.feeds.get_trending(limit=10)
```
...
feed = client.custom_feeds.create(
    ...
    operators=[
        {"type": "rss", "value": "https://example.com/ai-feed.xml"},
        {"type": "bluesky", "value": "did:plc:abc123"},
...
manifest = client.audio.get_manifest(station["id"])
